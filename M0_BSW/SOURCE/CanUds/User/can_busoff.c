...
static const stBUSOFF_CFG s_busoff_cfg[CAN_CHN_NUM] =
{
    /* CAN_CHN_0 */
    {
        BUSOFF_FAST_RELOAD_TIME, /* fast_period : 1ms */
        BUSOFF_SLOW_RELOAD_TIME, /* slow_period : 1ms */
        BUSOFF_FAST_TICK, /* fast_times */
        BUSOFF_SLOW_TICK /* slow_times : recovery times is 0, unlimited */
    },
    /* CAN_CHN_1 */
    {
        100, /* fast_period : 1ms */
