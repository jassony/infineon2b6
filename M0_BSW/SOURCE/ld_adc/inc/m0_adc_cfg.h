...
#define ADC1_HEAT_M                     ADC1_HEAT_M_CH12 - ADC1_SOFT_START + ADC_CHN_NUM_THICK
#define ADC1_HEAT_OUT                   ADC1_HEAT_OUT_CH13 - ADC1_SOFT_START + ADC_CHN_NUM_THICK
#define ADC1_HEAT_IN                    ADC1_HEAT_IN_CH14 - ADC1_SOFT_START + ADC_CHN_NUM_THICK
#define ADC1_T_SENSE_SIC_COMPRESS       ADC1_T_SENSE_SIC_COMPRESS_CH15 - ADC1_SOFT_START + ADC_CHN_NUM_THICK
#define ADC1_T_SENSE_SIC_HEAT           ADC1_T_SENSE_SIC_HEAT_CH22 - ADC1_SOFT_START + ADC_CHN_NUM_THICK
...
void Adc_SetSampleTime_Dynamic(uint16_t newSampleTime);
