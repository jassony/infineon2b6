...
#define THICK_PWM_PERIOD   4000 //   计算 80,000,000/8000 = 10,000HZ     //厚膜输出频率  计算 80,000,000/THICK_PWM_PERIOD
...
//    /* Enable Interrupt */
    ...
    Cy_TrigMux_Connect1To1(TRIG_IN_1TO1_1_TCPWM_TO_PASS_CH_TR36,CY_TR_MUX_TR_INV_DISABLE,TRIGGER_TYPE_PASS_TR_SAR_CH_IN__EDGE,0u); //1to1绑定
...
{
  Cy_Tcpwm_Counter_SetCompare0(TCPWMx_GRPx_CNTx_THICK, (uint32_t)per*THICK_PWM_PERIOD/100);
}