...
const stDCM_DID_CFG g_dcm_did_cfg[DCM_DID_NUM] = 
{
    ...
    {
        .did                            = DID_SYSTEM_SUPPLIER_ECU_M0_SOFTWARE_VERSION, /* DID_TYP_F194 */
...
const stDCM_SERVICE_CFG g_dcm_service_cfg[] = 
{
    ...
    /* 0x31 */
    {
        ...
        .callback                       = bl_service_31_cbk,
        .cbk_param                      = &g_sid31_dp_info,
        .nrc78_result                   = &g_service_31_nrc78_result
    },
    /* 0x34 */
    {
        .sid                            = DCM_SID_34,
