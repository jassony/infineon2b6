...
//uint08                      did_0100_val[DID_0100_DATA_LEN];
//uint08                      did_f182_val[DID_F182_DATA_LEN];
//uint08                      did_f184_val[DID_F184_DATA_LEN];
//uint08                      did_f187_val[DID_F187_DATA_LEN];
//uint08                      did_f190_val[DID_F190_DATA_LEN];
//uint08                      did_f191_val[DID_F191_DATA_LEN];
//uint08                      did_f192_val[DID_F192_DATA_LEN];
//uint08                      did_f193_val[DID_F193_DATA_LEN];
//uint08                      did_f194_val[DID_F194_DATA_LEN];
//uint08                      did_f195_val[DID_F195_DATA_LEN];
//uint08                      did_f188_val[DID_F188_DATA_LEN];
//uint08                      did_f189_val[DID_F189_DATA_LEN];
//uint08                      did_f19c_val[DID_F19C_DATA_LEN];
//uint08                      did_f19d_val[DID_F19D_DATA_LEN];
//uint08                      did_f1a1_val[DID_F1A1_DATA_LEN];
//uint08                      did_f1c0_val[DID_F1C0_DATA_LEN];
//
//static const uint08 s_did_f182_data[DID_F182_DATA_LEN] = {0};
//static const uint08 s_did_f187_data[DID_F187_DATA_LEN] = {"1300280-3115-C00"};
//static const uint08 s_did_f191_data[DID_F191_DATA_LEN] = {'H', '.', 'W'};
//static const uint08 s_did_f192_data[DID_F192_DATA_LEN] = {'H', '.', 'W'};
//static const uint08 s_did_f193_data[DID_F193_DATA_LEN] = {'V', '1', '.', '0', '0'};
//static const uint08 s_did_f1c0_data[DID_F1C0_DATA_LEN] = {'V', '1', '.', '0', '0'};
//static const uint08 s_did_f194_data[DID_F194_DATA_LEN] = {'S', '.', 'W'};
//static const uint08 s_did_f188_data[DID_F188_DATA_LEN] = {'S', '.', 'W'};
//static const uint08 s_did_f189_data[DID_F189_DATA_LEN] = {'V', '1', '.', '0', '0'};
//static const uint08 s_did_f195_data[DID_F195_DATA_LEN] = {'V', '0' + LOCAL_SW_VER_H, '.', '0' + LOCAL_SW_VER_M, '0' + LOCAL_SW_VER_L};
//static const uint08 s_did_f1a1_data[DID_F1A1_DATA_LEN] = {"LVB10"};
//static const uint08 s_did_f19c_data[DID_F19C_DATA_LEN] = {0};
...
static void uds_service_2e_process(void)
{
    ...
    {
        if (DID_TYP_F199 == g_service_2e.did_typ)
        {
            addr = DID_F199_ADDR;
