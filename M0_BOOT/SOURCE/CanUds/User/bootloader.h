...
//#define APP_A_VALID_ADDR                                0x10007004
//#define APP_B_VALID_ADDR                                0x10007008

/* eeprom address */
#define APP_UPDATE_FLAG_ADDR                            CY_WFLASH_SM_SBM_BASE + 0 * CY_WORK_SES_SIZE_IN_BYTE //app升级标志
#define APP_VALID_ADDR                                  CY_WFLASH_SM_SBM_BASE + 1 * CY_WORK_SES_SIZE_IN_BYTE
#define APP_BOOT_CHG_FLAG_ADDR                          CY_WFLASH_SM_SBM_BASE + 2 * CY_WORK_SES_SIZE_IN_BYTE //app boot 交互标志位
#define APP_BOOT_JUMP_FLAG_ADDR                         CY_WFLASH_SM_SBM_BASE + 3 * CY_WORK_SES_SIZE_IN_BYTE //app boot 交互标志位

#define APP_PREPROGRAM_TOTAL_SIZE                       (ECU_END_ADDR - APP_PREPROGRAM_START_ADDR)//(APP_A_END_ADDR + 1U - APP_A_START_ADDR)
...
#define BOOT_COMM_TIME                                  3000U
#define BL_APP_DW_TIME                                  3000U
#define BL_GO_APP_TIME                                  30U
#define BL_RESET_WAIT_TIME                              1000U
#define BL_GO_RESET_TIME                                1000U
...
typedef struct _bl_dependencies                         stBL_DEPENDENCIES;
