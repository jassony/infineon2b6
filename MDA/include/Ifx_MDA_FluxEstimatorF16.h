...
typedef struct Ifx_MDA_FluxEstimatorF16
{
    ...
    /** Phase resistance normalized in Q15. */
    Ifx_Math_Fract16 p_phaseResistanceQ15;

    /** Phase inductance normalized in Q15 and its adjusted execution value. */
    Ifx_Math_Fract16 p_phaseInductanceQ15;
    Ifx_Math_Fract16 p_phaseInductanceAdjustedQ15;

    /** System base time in Q30, used for electrical speed normalization. */
    Ifx_Math_Fract32 p_systemBaseTimeQ30;
 ...
 *
 *  This API performs the speed and angle estimation of the rotor flux.
 *
 *  Inputs of this API:
 *  <ul>
...
/** Updates motor-dependent fixed-point parameters without resetting estimator state. */
