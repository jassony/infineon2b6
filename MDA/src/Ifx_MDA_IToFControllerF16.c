...
#define IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTID_SOURCEID     ((uint8)Ifx_ComponentID_SourceID_infineonTechnologiesAG)
#define IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTID_LIBRARYID    ((uint16)Ifx_ComponentID_LibraryID_mctrlDriveAlgorithm)
#define IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTID_MODULEID     (2U)
#define IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTID_COMPONENTID1 (1U)

#define IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTID_COMPONENTID2 ((uint8)Ifx_ComponentID_ComponentID2_eco)

/* Macros to define the component version */
#define IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTVERSION_MAJOR   (1U)
#define IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTVERSION_MINOR   (2U)
#define IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTVERSION_PATCH   (0U)
#define IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTVERSION_T       (0U)
#define IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTVERSION_REV     (0U)

/* Component ID */
static const Ifx_ComponentID      Ifx_MDA_IToFController_CYT2B7_componentID = {
    .sourceID                                                                 =
        IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTID_SOURCEID, .libraryID        =
        IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTID_LIBRARYID, .moduleID        =
        IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTID_MODULEID, .componentID1     =
        IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTID_COMPONENTID1, .componentID2 =
        IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTID_COMPONENTID2,
};

/* Component Version */
static const Ifx_ComponentVersion Ifx_MDA_IToFController_CYT2B7_componentVersion = {
    .major                                                           =
        IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTVERSION_MAJOR, .minor =
        IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTVERSION_MINOR, .patch =
        IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTVERSION_PATCH, .t     =
        IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTVERSION_T,
    .rev                                                             =
        IFX_MDA_ITOFCONTROLLER_CYT2B7_COMPONENTVERSION_REV
};
...
{
    *componentID = &Ifx_MDA_IToFController_CYT2B7_componentID;
}
...
{
    *componentVersion = &Ifx_MDA_IToFController_CYT2B7_componentVersion;
}
