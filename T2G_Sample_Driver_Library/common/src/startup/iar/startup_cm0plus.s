...
__vector_table:
		...
		SECTION .intvec_app:CODE:ROOT(8)
        DATA

__vector_table_app:
        DCD     sfe(CSTACK)        
		DCD		Reset_Handler_contd
        DCD     NMI_Handler
...
__Vectors       EQU   __vector_table_app
...
;jump to Reset_Handler_contd function	
_jumptoapplicationreset: 							
		LDR   r7, =Reset_Handler_contd
		BX    r7	
     
;************************************************************************
;* Start-up Code Continuation
;************************************************************************
      THUMB
	  PUBWEAK Reset_Handler_contd	
	  SECTION .text:CODE:REORDER:NOROOT(2)        	
Reset_Handler_contd:
_startcontd:
