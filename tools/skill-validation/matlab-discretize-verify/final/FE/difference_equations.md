...
Gd(z) = (dv_test_K*dv_test_T)/(dv_test_T - dv_test_tau + dv_z*dv_test_tau)
```
...
```text
a(q): [1, (dv_test_T - dv_test_tau)/dv_test_tau]
b(q): [0, (dv_test_K*dv_test_T)/dv_test_tau]
a_numeric: [1 -0.94999999999999996]
b_numeric: [0 0.10000000000000001]
```
