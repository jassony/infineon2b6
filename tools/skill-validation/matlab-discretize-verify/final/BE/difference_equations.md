...
Gd(z) = (dv_z*dv_test_K*dv_test_T)/(dv_z*dv_test_T - dv_test_tau + dv_z*dv_test_tau)
```
...
Symbolic:
```text
dv_test_tau/(dv_test_T + dv_test_tau)
```
Numeric:
```text
0.95238095238095233
...
Symbolic:
```text
(dv_test_T*dv_test_tau)/(dv_test_T + dv_test_tau)
```
Numeric:
```text
...
Symbolic:
```text
dv_test_K/(dv_test_T + dv_test_tau)
```
Numeric:
```text
95.238095238095241
...
Symbolic:
```text
(dv_test_K*dv_test_T)/(dv_test_T + dv_test_tau)
```
Numeric:
```text
...
```text
a(q): [1, -dv_test_tau/(dv_test_T + dv_test_tau)]
b(q): (dv_test_K*dv_test_T)/(dv_test_T + dv_test_tau)
a_numeric: [1 -0.95238095238095233]
b_numeric: 0.095238095238095233
```
