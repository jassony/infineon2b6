function result = powerfit_run_state_machine_closedloop_rated_350v_20260907()
%POWERFIT_RUN_STATE_MACHINE_CLOSEDLOOP_RATED_350V_20260907 Refit 9 MF4 logs.
...
cfg.Profile.FitGroupId = "rated_350V_20260907_state_machine_closedloop";
cfg.FitGroupId = cfg.Profile.FitGroupId;
cfg.DatabaseFile = fullfile(toolFolder, "local_data", ...
    "rated_350V_20260907_state_machine_closedloop_database.mat");
...
result = powerfit_state_machine_closedloop_batch(cfg.InputFolder, cfg);
end
